...
function Apropos(){
    ...
    return(
        <div className={styles.content}>
            <Header/>
            <Banner/>
            <ul className={styles.content__itemList}>{pageContent.map((item)=>
            <li className={styles.content__itemList__item} key={item.title}><Collapse title={item.title} content={item.content} size='large'/></li>
            )}
